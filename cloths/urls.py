...
urlpatterns = [
    ...
    path(r'list/(?P<slug>[0-9]+)/$', views.ClothDetailView.as_view(), name='cloth_detail'),
    path('list/comment/<int:cloth_id>/', views.CommentCreateView.as_view(), name='comment_create'),
]